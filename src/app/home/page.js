        ...
        <AnimatePresence mode="wait">
          {step === 1 && (
            <motion.div key="step1" {...slideVariants}>
              ...
              <input type="time" style={inputStyle} onChange={(e) => updateField('time', e.target.value)} />
            </motion.div>
          )}
          ...
          {step === 2 && (
            <motion.div key="step2" {...slideVariants}>
              ...
              <select style={inputStyle} onChange={(e) => updateField('day', e.target.value)}>
          ...
          {step === 3 && (
            <motion.div key="step3" {...slideVariants}>
              ...
              <input type="week" style={inputStyle} onChange={(e) => updateField('week', e.target.value)} />
            </motion.div>
          )}
          ...
          {step === 4 && (
            <motion.div key="step4" {...slideVariants}>
              ...
              <input type="text" placeholder="Ex: Gym, Study..." style={inputStyle} onChange={(e) => updateField('task', e.target.value)} />
            </motion.div>
          )}
...
const inputStyle = { width: '100%', padding: '15px', marginBottom: '30px', borderRadius: '12px', border: 'none', background: 'rgba(255,255,255,0.1)', color: 'white', fontSize: '16px', outline: 'none' };
const buttonStyle = { width: '100%', padding: '15px', borderRadius: '12px', border: 'none', background: 'linear-gradient(90deg, #8b5cf6, #d946ef)', color: 'white', fontWeight: 'bold', fontSize: '18px', cursor: 'pointer' };
